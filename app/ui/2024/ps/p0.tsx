...
import bg from "@/public/2024/ps/bgp0.png";
import ava0 from "@/public/2024/ps/ava0.png";
import ava2 from "@/public/2024/ps/ava2.png";
        ...
        <div className="relative h-screen">
            ...
            <div className="absolute z-[7] bottom-[-10%] left-[50%] translate-x-[-50%] w-[100%] h-[30vh]">
                <Image
                    ...
                    src={ava0} alt="ava0"/>
                <Image
                    className="absolute bottom-[15%] left-[-15%] w-[70%] transition-all"

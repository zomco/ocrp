    ...
    return (
        <div className="relative h-screen">
            ...
            <div className="absolute z-[6] top-[20%] left-[50%] translate-x-[-50%] w-[80%] h-[60vh]">
                ...
                >
                    <p>1、本活动课程为秋色赛会公益类暑假班；</p>
                    <p>2、课程接受社会报名，限7~16周岁的学生报名，且每人仅限参与一项，赛会将评比出优秀作品；每门课程为30个名额，额满为止；报名系统将收取前40名提交的报名者信息，在报名系统提交信息成功后将显示“提交成功”，若前30名报名者中，有因故不能参加者，则从后10名报名者中按信息提交时间顺序补录；报名者须按要求认真填写真实信息，选择参与课程(“佛山剪纸”、“佛山木雕”、“小龙舟制作”、“岭南书法”、“大良鱼灯”)；填写信息与本人不符者均视为自动放弃；信息提交后，请学生家长留意工作人员电话通知（来电号码为固话），经电话确认后方为报名成功，并及时加入相应的“课程通知群”；</p>
                    <p>3、由于课程的连贯性，凡报名者需确保出勤率，并积极提交作品参加评选，不得无故缺席和迟到早退，如违反上述规定将影响再次参与相关活动。请家长留意上课的时间和地点，尊重小朋友的意愿和爱好，谨慎报名，坚持上课；</p>
                </div>
            </div>

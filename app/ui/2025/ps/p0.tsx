...
import bg from "@/public/2025/ps/bgp0.png";
import ava0 from "@/public/2025/ps/ava0.png";
import ava2 from "@/public/2025/ps/ava1.png";
...
export default function P0({ shown } : { shown: boolean }) {
    ...
    return (
        <div className="relative h-screen">
            ...
            <div className="absolute z-[32] top-[38%] left-[50%] translate-x-[-50%] translate-y-[-50%] w-[60%]">
                <div
                    className={`content-center flex justify-center items-center transition-all mb-10`}
                    style={{transform: shown ? 'translateY(0em)' : 'translateY(-2rem)', opacity: shown ? '1' : '0'}}
                >
                    <div
                        className={'px-6 font-bold text-[1.5rem] text-center text-white bg-[#76c051] rounded-full'}>-线上报名-
                    </div>
                </div>
                {
                    isSubmit ? (
            ...
            <div className="absolute z-[7] bottom-[-10%] left-[50%] translate-x-[-50%] w-[100%] h-[30vh]">
                <Image
                    className="absolute bottom-[50%] right-[12%] w-[40%] transition-all"
                    style={{transform: shown ? 'translateY(0em)' : 'translateY(2rem)', opacity: shown ? '1' : '0'}}
                    src={ava0} alt="ava0"/>
                <Image
                    className="absolute bottom-[65%] left-[6%] w-[40%] transition-all"
